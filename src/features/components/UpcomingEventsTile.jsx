...
const UpcomingEventsTile = () => {
  ...
  return (
    ...
    >
      ...
      <Box className="scroll-section-outer" overflow="hidden">
        <Box ref={triggerRef}>
          <Box
                  ...
                  <Flex height="100%" flexDir="column">
                    <Box>
                      ...
                      <Box sx={playlistPosterButtonContainer}>
                        ...
                        <Link
                          isExternal
                          href="https://music.apple.com/za/album/ukhamba/1685664203"
                        >
                          <Button sx={buttonStyle}>Playlist</Button>
                        </Link>
                      </Box>
                    </Box>
                  </Flex>
                  ...
                  <Flex height="100%" flexDir="column">
                    <Box>
                      ...
                      <Box sx={playlistPosterButtonContainer}>
                        ...
                        <Link
                          isExternal
                          href="https://music.apple.com/za/playlist/boyz-ii-men-essentials/pl.95bfdb84270a41509e118bb25955f0b0"
                        >
                          <Button sx={buttonStyle}>Playlist</Button>
                        </Link>
                      </Box>
